    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 mb-4 mb-md-0">
                <div class="row">
                    <div class="col-lg-6">
                        <h2 class="text-color-quaternary text-uppercase font-weight-extra-bold">About me</h2>

                        <p class="custom-text-color-2">Full Stack Web Developer with 10+ years experience in creating web-applications and configuring servers. Agile Kanban/Scrum Methodologies.</p>
                        <p class="custom-text-color-2">Working with PHP frameworks (Laravel, Yii), SQL (MySQL, PostgreSQL), MongoDB, JQuery, Bootstrap, Flexbox, HTML5, Git, Docker. Learning React.</p>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class="progress-bars custom-progress-bars custom-md-margin-top-1">
                            ...
                            <div class="progress mb-2">
                                <div class="progress-bar" data-appear-progress-animation="40%" data-appear-animation-delay="300"></div>
                            </div>
                            <div class="progress-label text-color-dark font-weight-semibold text-uppercase text-2">
                                <span>NodeJS</span>
                            </div>
                            <div class="progress mb-2">
                                <div class="progress-bar" data-appear-progress-animation="20%" data-appear-animation-delay="600"></div>
                            </div>
                            <div class="progress-label text-color-dark font-weight-semibold text-uppercase text-2">
                                <span>MongoDB</span>
                            </div>
                            <div class="progress mb-2">
                                <div class="progress-bar" data-appear-progress-animation="60%" data-appear-animation-delay="900"></div>
                            </div>
                        </div>
                    </div>
                    {{--<div class="col-lg-4">
                        <div class="progress-bars custom-progress-bars custom-md-margin-top-1">
                            ...
                            <div class="progress mb-2">
                                <div class="progress-bar" data-appear-progress-animation="50%" data-appear-animation-delay="600"></div>
                            </div>
                            <div class="progress-label text-color-dark font-weight-semibold text-uppercase text-2">
                                <span>Git</span>
                            </div>
